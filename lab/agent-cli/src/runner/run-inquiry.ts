...
export async function runInquiry(options: RunInquiryOptions): Promise<void> {
  ...
  if (!gate.approved) {
    ...
    printNextCommand({
      ...
      description: 'Reexecutar inquiry após ajustar estratégia e critérios de persistência.',
  ...
  printNextCommand({
    command: 'reverso dig',
    description: 'Reavaliar fontes e abrir novas linhas para a próxima rodada.',
