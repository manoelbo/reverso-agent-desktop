...
export const TerminalContent = ({
  ...
  return (
    <div
      className={cn(
        "min-h-0 flex-1 overflow-auto p-4 font-mono text-sm leading-relaxed [scrollbar-width:thin] [scrollbar-color:rgb(63_63_70)_transparent] [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-zinc-700/70 [&::-webkit-scrollbar-thumb]:transition-colors [&::-webkit-scrollbar-thumb:hover]:bg-zinc-500/80 [&::-webkit-scrollbar-track]:bg-transparent",
        className
      )}
      ref={containerRef}
      {...props}
